    ...
    GoRouter(
      ...
      routes: [
        ...
        FFRoute(
          ...
          asyncParams: {
            'dreamDoc': getDoc(['dreams'], DreamsRecord.fromSnapshot),
          },
          builder: (context, params) => ViewDreamUserWidget(
            dreamDoc: params.getParam(
              'dreamDoc',
              ParamType.Document,
            ),
          ),
        ...
        FFRoute(
          name: DreamListWidget.routeName,
          path: DreamListWidget.routePath,
          builder: (context, params) => params.isEmpty
              ? NavBarPage(initialPage: 'DreamList')
              : DreamListWidget(),
        ),
        FFRoute(
        ...
        FFRoute(
          ...
          path: ViewDreamOtherWidget.routePath,
          asyncParams: {
            'dreamView': getDoc(['dreams'], DreamsRecord.fromSnapshot),
            'authorDoc': getDoc(['users'], UsersRecord.fromSnapshot),
          },
          builder: (context, params) => ViewDreamOtherWidget(
            dreamView: params.getParam(
              'dreamView',
              ParamType.Document,
            ),
            authorDocReference: params.getParam(
              'authorDocReference',
              ParamType.DocumentReference,
              isList: false,
              collectionNamePath: ['users'],
            ),
            authorDoc: params.getParam(
              'authorDoc',
              ParamType.Document,
            ),
          ),
